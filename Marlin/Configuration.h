/**
 * Marlin 3D Printer Firmware Dollywood 2.0 2019
...
#define STRING_CONFIG_H_AUTHOR "(G Williams WOOD, DollyWood 2.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "DollyWood 2.0 VI"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "f91b1d41-07ce-4eea-9c1f-6e3b8ed4a989"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 28, 0, -2.45 }
...
// OLD code 90% it can go #define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST / 4)
