...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LED_CONTROL_MENU
    ...
    #define LED_COLOR_PRESETS                 // Enable the Preset Color menu option
      ...
      #define LED_USER_PRESET_BRIGHTNESS 254  // User defined intensity
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT        3  // was 13 //(mm) Unload initial retract length.
  #define FILAMENT_UNLOAD_PURGE_DELAY       2000  // was 5000 //(ms) Delay for the filament to cool after retract.
  #define FILAMENT_UNLOAD_PURGE_LENGTH        18  // was 8(mm) An unretract is done, then this length is purged.
