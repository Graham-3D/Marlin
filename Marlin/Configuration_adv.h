...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT       2  // was 13 //(mm) Unload initial retract length.
  #define FILAMENT_UNLOAD_PURGE_DELAY        200  // was 5000 //(ms) Delay for the filament to cool after retract.
  #define FILAMENT_UNLOAD_PURGE_LENGTH        5  // was 8(mm) An unretract is done, then this length is purged.
